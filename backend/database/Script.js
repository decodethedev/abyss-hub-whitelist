...
async function getScriptBy(field, value) {
...
async function getScriptByPlaceID(placeID) {
...
async function updateScript(filter, update) {   
...
async function updateScriptString(filter, update) {   
...
async function deleteScriptByID(script_id) {
...
module.exports = {getAllScripts, deleteScriptByID, updateScriptString ,createScript, getScriptBy, updateScript, getScriptByPlaceID};